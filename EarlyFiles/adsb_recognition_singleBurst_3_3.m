...
cond1 = icaoOccurTb(:,2)>=600;
cond2 = icaoOccurTb(:,2)<=2000;
...
% 
% fpLayer2 = zeroBiasFCLayer(numClasses,numClasses,'Fingerprints2',[]);
% lgraph = addLayers(lgraph, fpLayer2);
% lgraph = connectLayers(lgraph, 'fc_bf_fp', 'Fingerprints2');
% lgraph = connectLayers(lgraph, 'Fingerprints2', 'add_2/in2');
...
weights = net.Layers(end-2).Weights;
